...
python3 -m torchrun --standalone --nnodes=1 --nproc_per_node=8     cluster_feature_gpu.py     --clusters-pkl data/double_cross_val_year_cluster_dfC-CD.pkl     --out $strong_features_path --reference-pkl $strong_features_path  --pca-model data/global_pca_model_4000.pkl
